          ...
          <div className="bg-white px-8 py-4">
            ...
            <ApiKeyCheck>
              <div className="flex gap-4 flex-wrap">
                <a
                  href="/forceui"
                  className="px-6 py-3 rounded-md font-medium shadow-sm transition-colors text-lg mt-4 bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white"
                >
                  🚀 Launch ForceUI →
                </a>
                <a
